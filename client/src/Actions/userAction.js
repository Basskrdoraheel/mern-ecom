...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await request.get(`/api/v1/admin/user/${id}`);
...
export const updateUser = (id, userData) => async (dispatch) => {
  try {
    ...
    console.log("🚀 ~ file: userAction.js:230 ~ updateUser ~ data:", data);
...
export const delUser = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await request.delete(`/api/v1/admin/user/${id}`);
